...
describe("accountManager", () => {
    ...
    beforeEach(() => {
        ...
        factory = () => {
            ...
            return require("../../../lib/manager/account-manager")(challengeManagerMock, config, promiseMock, randomMock, sessionManagerMock, storageServiceFactoryMock, totpMock, util);
        };
    });
