...
module.exports = function (base64, crypto, promise) {
    ...
    /**
     * Creates a secure hash and then encodes it into
     * Base 64.
     *
     * @param {string} data
     * @param {Object} config
     * @return {Promise.<string>}
     */
    function encodeAsync(data, config) {
    ...
    /**
     * Creates a secure has and then encodes it into
     * Base 64 safe for URI use.
     *
     * @param {string} data
     * @param {Object} config
     * @return {Promise.<string>}
     */
    function encodeUriAsync(data, config) {
        return createSecureHashAsync(data, config).then((hash) => {
