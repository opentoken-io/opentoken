 ...
 *
 * OtDate objects are designed to be immutable.  Methods that
 * change the internal date will return a new OtDate object.
 */
...
module.exports = (moment) => {
    ...
    class OtDate {
         ...
         *
         * @param {Moment} m
         * @throws {Error} when someone tries to use `new OtDate()`
         */
        constructor(m) {
        ...
        /**
         * Copies the date into a new object.
         *
         * @return {OtDate} Another object with the same date.
         */
        clone() {
            var cloneMoment;

            cloneMoment = moment(this.moment);

            return new OtDate(cloneMoment);
        }
        ...
        plus(spec) {
            ...
            otherDate = this.clone();
            otherDate.moment.add(spec);
     ...
     * @param {Date} d
     * @return {OtDate}
     * @throws {Error} when the input is not a Date object
     */
    OtDate.fromDate = (d) => {
