...
module.exports = (config, path, promise, tv4, validator) => {
    /**
    ...
    return () => {
        ...
        return promise.try(() => {
            ...
            return tv4.loadSchemaFolderAsync(schemaPath);
        }).then(() => {
            ...
            result = tv4.validateResult(config, "/config/config.json");
