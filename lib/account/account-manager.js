...
class AccountManager {
    ...
    completeAsync(accountInfo) {
        ...
        directory = this.accountService.getDirectory(accountInfo.accountId);
    ...
    initiateAsync(accountInfo) {
        return this.promise.props({
            ...
            return this.accountService.initiateAsync(this.accountService.getDirectory(bits.accountId), bits, options);
        });
    }
}
