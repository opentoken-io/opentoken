...
class AccountManager {
    ...
    complete(accountInfo) {
        return this.accountService.getAsync(accountInfo.accountId).then((accountFile) => {
            var options;
            ...
            return this.accountService.completeAsync(accountInfo.accountId, accountInfo, options);
        });
    }
    ...
    initiate(accountInfo) {
        return this.promise.props({
            ...
            return this.accountService.initiateAsync(bits.accountId, bits, options);
        });
    }
}
