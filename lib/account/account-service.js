...
class AccountService {
    ...
    initiate(accountId, accountInfo, options) {
        ...
        // fidian: don't do the wrapping of stuff here - that's another task
        contents = {
        ...
        return this.storage.putAsync(this.getDirectory(accountId), JSON.stringify(contents), options).then(() => {
            return contents;
        });
    }
}
