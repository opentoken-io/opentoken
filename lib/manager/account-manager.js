...
/**
 * @typedef {Object} opentoken~accountManager
 * @property {Function} createAsync
 * @property {Function} loginAsync
 * @property {Function} loginHashConfigAsync
 * @property {Function} logoutAsync
 * @property {Function} passwordHashConfigAsync
 * @property {Function} recordAsync
 */


/**
 * @param {opentoken~challengeManager} challengeManager
 ...
 * @param {opentoken~storageServiceFactory} storageServiceFactory
 * @param {opentoken~totp} totp
 * @param {opentoken~util} util
 * @return {opentoken~accountManager}
 */
module.exports = (challengeManager, config, promise, random, sessionManager, storageServiceFactory, totp, util) => {
    ...
    function logoutAsync(accountId, sessionId) {
        return sessionManager.deleteAsync(accountId, sessionId);
    }
