...
moduleDefs = {
    accountManager: "./account/account-manager",
    accountService: "./account/account-service",
    ...
    random: "./random",
    record: "./record",
    registrationManager: "./registration/registration-manager",
    ...
    storage: "./storage/s3",
    totp: "./mfa/totp",
    validateRequestMiddleware: "./validate-request-middleware",
