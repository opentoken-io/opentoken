...
container.instance("accountService", require("./service/account-service"));
container.instance("accountManager", require("./manager/account-manager"));
...
container.instance("hotp", require("./hotp/two-factor-authenticator"));
...
container.register("password", require("./password"));
